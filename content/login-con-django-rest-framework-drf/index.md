...
![Pantalla de Loggeo en Django REST framework](images/DjangoRestFrameworkEndpointLogin-1024x709.png)
...
![Pantalla de registro en Django REST Framework](images/DjangoRestFrameworkEndpointRegistro-1024x640.png)
...
![Token de sesión de DRF Obtenidas tras el logueo de un usuario.](images/DjangoRestFrameworkEndpointToken-1024x414.png)
...
![Tras el logueo de un usuario obtenemos el  JWT de refresco y de autenticación o acceso.](images/DjangoRestFrameworkJWT-1024x841.png)
