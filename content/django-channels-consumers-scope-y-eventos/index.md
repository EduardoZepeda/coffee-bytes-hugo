...
Un canal o channel es un modelo que permite que varios procesos se comuniquen entre sí por medio de la transmisión de mensajes. django-channels debe su nombre a este concepto y el concepto es bastante similar al que te encontrarías en lenguajes de programación como [Go](https://coffeebytes.dev/python-vs-go-cual-es-el-mejor-diferencias-y-similitudes/).
...
![Esquema simplificado de un websocket y un consumer](images/websocketYConsumer-1-1024x1024.png)
...
![](images/ProtocolTyperouter-2-1024x853.png)
