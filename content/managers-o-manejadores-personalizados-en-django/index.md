...
Antes de empezar, si no sabes lo básico de Django puedes empezar con [este libro gratuito.](https://coffeebytes.dev/el-libro-definitivo-de-django/)

Por otro lado, si estás buscando optimizar tu aplicación de Django, probablemente [mi entrada donde hablo sobre como mejorar el rendimiento de una app de Django](https://coffeebytes.dev/como-mejorar-el-rendimiento-de-una-aplicacion-hecha-en-django/) te sirva más.
