...
![Estadísticas en Locust](images/EstadisticasLocust-1024x129.png)
...
![Peticiones totales por segundo](images/PeticionesPorSegundo-1024x200.png)

El segundo con el tiempo de respuesta en el eje de las Y.

![Tiempo de respuesta](images/TiempoDeRespuesta-1024x200.png)

Por último, el tercero, con el número de usuarios en el eje de las Y.

![Número de usuarios](images/NumeroDeUsuarios-1024x200.png)
...
![Error personalizado](images/ErrorPersonalizadoLocust-1024x124.png)
