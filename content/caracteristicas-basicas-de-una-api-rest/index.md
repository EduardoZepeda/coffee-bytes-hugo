...
![Captura de imagen de Open API, documentación automática para API REST](images/Documentacion_swagger-1024x165.png)
...
![GUI, de insomnia, una aplicación para el testeo de una API REST](images/InsomniaGUI-1024x595.png)
