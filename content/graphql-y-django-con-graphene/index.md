...
![Esquema del funcionamiento de graphql en Javascript](images/EsquemaGraphqlSimplificado-1024x281.png)
...
![Diferencia en la interfaz al poner graphiql como True o False](images/graphiqlTrueOrFalse-1024x414.png)
...
![Error por no definir un schema en graphene](images/aSchemaIsRequired-1024x652.png)
...
Recuerda que el resultado de la query lo decidimos nosotros, yo he usado un simple _icontains_ para una búsqueda insensible a mayúsculas o minúsculas, pero tú puedes usar lo que quieras, incluso un [full text search](https://coffeebytes.dev/full-text-search-y-busquedas-con-django-y-postgres/), [búsquedas avanzadas con trigramas con postgres](https://coffeebytes.dev/trigramas-y-busquedas-avanzadas-con-django-y-postgres/) o lo que prefieras.
