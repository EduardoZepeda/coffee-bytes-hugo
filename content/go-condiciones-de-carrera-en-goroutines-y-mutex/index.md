...
![Ejemplo de una race condition o condición de carrera en go](images/race-conditions-go-1024x1024.png)
...
![El método Lock de Mutex bloquea el acceso del código, mientras que el método Unlock lo libera.](images/mutex-lock-en-go-1024x691.png)
