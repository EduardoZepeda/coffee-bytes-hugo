...
![Tamaño de la librería HTMX. 105 kB normal, 32 kB minimizado y 10.8 comprimido en gzip.](images/TamanoDeHTMX-1024x383.png)
...
![](images/HtmxEsquema-945x1024.jpg)
...
![La etiqueta head no se carga directamente si accedemos a la ruta ](images/LaEtiquetaHeadNoSeCarga.gif)
...
![Parámetros POST que manda de manera automática htmx ](images/PeticionHTTPPost-1024x197.png)
...
![Lista de encabezados extra son agregados en cada petición](images/EncabezadosHtmx-1024x398.png)
