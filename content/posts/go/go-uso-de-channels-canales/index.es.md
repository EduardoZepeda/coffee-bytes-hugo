...
Los channels son usados para comunicar goroutines, como en el [patrón de diseño worker pool](/es/Arquitectura de software/explicacion-del-patron-de-diseno-worker-pool/)
