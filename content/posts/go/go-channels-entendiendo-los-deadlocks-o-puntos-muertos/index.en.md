...
{{< figure src="https://res.cloudinary.com/dwrscezd2/image/upload/v1760308345/coffee-bytes/deadlock-sender-go_gbdaas.jpg" class="md-local-image" alt="Deadlock due to lack of input channel" caption="There is no operation that sends data through a channel."  width="1200" height="1200" >}}
...
{{< figure src="https://res.cloudinary.com/dwrscezd2/image/upload/v1760308345/coffee-bytes/deadlock-receiver-go_dpi9hq.jpg" class="md-local-image" alt="Deadlock due to lack of output channel" caption="In a deaclock due to lack of output channel there is no operation that receives text through a channel."  width="1200" height="1200" >}}
