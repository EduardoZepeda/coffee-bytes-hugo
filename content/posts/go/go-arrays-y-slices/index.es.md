...
{{< figure src="images/arrayGolang-1.png" class="md-local-image" alt="Estructura de un array en go"  width="800" height="200" >}}
...
{{< figure src="images/sliceGolang.png" class="md-local-image" alt="Estructura de un slice en go" caption="Un apuntador del slice dirige a los datos que contiene"  width="800" height="200" >}}
