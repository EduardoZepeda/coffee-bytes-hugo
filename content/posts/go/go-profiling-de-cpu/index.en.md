...
{{< figure src="images/GoListProfile.png" class="md-local-image" alt="Results of the list profiling command in go showing the impact of each line of code."  width="1204" height="241" >}}
...
{{< figure src="images/GoWebProfile.png" class="md-local-image" alt="Result of the profiling web command in go. The fibonacci function is shown in large and red"  width="1002" height="806" >}}
...
{{< figure src="images/GoWebProfileFunction.png" class="md-local-image" alt="Web command allows to isolate results by function"  width="915" height="519" >}}
