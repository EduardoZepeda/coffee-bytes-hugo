...
You should also make sure that your file has the proper execution permissions, I have a post explaining the topic of [chmod and permissions in GNU/Linux](/understand-permissions-in-gnu-linux-and-the-chmod-command/) that you can check out.
