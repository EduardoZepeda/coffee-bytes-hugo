...
Also if you're interested in diving into this programming language [here's my list of favorite resources to learn Python]({{< ref path="/posts/best-source-to-learn-python/index.md" lang="en" >}})
