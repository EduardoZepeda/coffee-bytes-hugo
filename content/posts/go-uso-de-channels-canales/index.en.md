...
It is important to define the type of channel because, with bidirectional channels, we run the risk of causing a [deadlock in our go program](/blog/go-channels-understanding-the-deadlocks/).
