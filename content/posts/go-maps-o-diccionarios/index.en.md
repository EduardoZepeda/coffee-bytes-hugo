...
Together with the [array and the go slice](/go-slices-y-arrays-characteristicas-and-basic-uses/), a map is a structure that serves as a collection of values.
