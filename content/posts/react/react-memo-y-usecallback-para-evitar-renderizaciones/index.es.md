...
date: '2021-08-10'
seo_title: "React memo y useCallback: Evitar Renderizaciones"
description: Aprende a usar React memo y useCallback para optimizar renderizaciones
  y mejorar el rendimiento de tu aplicación.
keywords:
- javascript
- react
- rendimiento
...
{{< figure src="images/eliminandoMemo.gif" class="md-local-image" alt="Eliminar memo del componente hijo causa renderizaciones"  width="1461" height="877" >}}
...
{{< figure src="images/eliminandoUseCallback.gif" class="md-local-image" alt="Eliminar useCallback del componente hijo causa renderizaciones"  width="1461" height="877" >}}
