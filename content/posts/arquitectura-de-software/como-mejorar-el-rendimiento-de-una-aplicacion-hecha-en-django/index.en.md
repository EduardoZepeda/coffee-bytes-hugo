...
It's also a good time to remember that if your application is just starting out, you probably [shouldn't obsess about its performance... yet](/en/opinions/dont-obsess-about-your-web-application-performance/).
...
* **select_related** to [avoid multiple searches in foreign key or one-to-one relationships](/en/arquitectura-de-software/differences-between-select_related-and-prefetch_related-in-django/)
...
If your application makes heavy use of information searches, consider using an efficient [search engine, such as Solr](/en/django/searches-with-solr-with-django-haystack/), rather than implementing the code yourself.
...
Do you want to know how much difference there is between Python and a compiled language like go? in my post [Python vs Go I compare the speed of both languages](/en/go/python-vs-go-go-which-is-the-best-programming-language/)
