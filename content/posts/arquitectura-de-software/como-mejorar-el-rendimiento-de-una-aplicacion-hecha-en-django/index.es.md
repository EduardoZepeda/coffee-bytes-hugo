...
También es buen momento para recordar que si tu aplicación va empezando, probablemente [no deberías obsesionarte con su rendimiento... aún](/es/opiniones/no-te-obsesiones-con-el-rendimiento-de-tu-aplicacion-web/).
...
- **select_related** para [evitar múltiples búsquedas en relaciones tipo llave foránea o uno a uno](/es/django/diferencias-entre-select-related-y-prefetch-related-en-django/)
...
- **annotate y subqueries** Ten cuidado con la forma en que Django utiliza [anotar y subconsultas y escribir CTEs o SQL en crudo]({{< ref path="/posts/django/managers-o-manejadores-personalizados-en-django/index.md" lang="en" >}}) si es necesario.
...
Si tu aplicación hace un uso intensivo de las búsquedas de información, considera usar un [motor de búsqueda eficiente, como Solr](/es/django/busquedas-con-solr-con-django-haystack/), en lugar de implementar el código por ti mismo.
...
Existen muchas opciones de CDN disponibles, entre las opciones más populares están AWS, [Azure](/es/arquitectura de software/examen-de-certificacion-azure-az-900-mi-experiencia/), Digital Ocean, Cloud Flare, entre otras.
...
¿Quieres saber que tanta diferencia hay entre Python y un lenguaje compilado como go? en mi entrada [Python vs Go comparo la velocidad de ambos lenguajes.](/es/go/python-vs-go-cual-es-el-mejor-lenguaje-de-programacion/)
