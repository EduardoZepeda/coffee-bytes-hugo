...
Worker pool es un [patrón de diseño](/es/python/patrones-de-diseno-o-software-design-patterns/) que viene para suplir estas deficiencias. 
...
Este patrón de diseño es muy útil cuando hay que procesar candidades enormes de tareas y cuando no queremos sobrecargar el sistema. Y, como puedes suponer es bastante popular y útil en lenguajes de programación que utilizan fuertemente la concurrencia, tales como [el lenguaje de programación Go.](/es/go/go-lenguaje-de-programacion-introduccion-a-variables-y-tipos-de-datos/)