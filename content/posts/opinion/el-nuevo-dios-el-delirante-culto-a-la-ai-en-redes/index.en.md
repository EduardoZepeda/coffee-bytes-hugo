...
description: 'An analysis of the excessive worship of AI on social media, from corporate hype to digital inquisitors.'
keyword: ''
keywords:
- AI
- cult
...
In the corporate world there is also a cult, but I understand it. **AI gurus promised investors they could get rid of most of their employees** and thereby reduce their costs, raising their profits to almost the same level as their egos. This sparked strong interest and probably [an AI financial bubble]({{< ref path="/posts/artificial-intelligence/la-burbuja-de-ai-y-sus-consecuencias/index.md" lang="es" >}})
...
The investors adopted the idea and **heavily invested in turning their companies into *AI-first*** entities, despite evidence showing [that 95% of companies fail to benefit financially after AI adoption](https://mlq.ai/media/quarterly_decks/v0.1_State_of_AI_in_Business_2025_Report.pdf) or that [AI fails to complete remote projects at this same percentage](https://arxiv.org/html/2510.26787v1).
...
But we don't have to settle for such a partial opinion. Economists estimate that [AI will bring infinite productivity with a demand for goods and services that tends to zero](https://arxiv.org/abs/2603.20617). The perfect ecosystem for an economic collapse.
...
People believe AI will come out of the digital world and save them from the "day-to-day" hardships that threaten them. They gave them an excuse to give up [creating texts](https://www.sciencedirect.com/science/article/pii/S2666920X2500147X), illustrations, music, etc. since "AI can do it for me".

It makes me sad, because people don't realize how badly AI really writes (yes, even worse than me), its strong positivity bias, and [how trivial it is to tell that a text was written by AI](https://arxiv.org/pdf/2509.19163).
...
![The AI bros of yesterday were the crypto bros of today, but worse](https://res.cloudinary.com/dwrscezd2/image/upload/v1777744916/coffee-bytes/crypto-bros-then-now-meme_yxyxeh.jpg)
...
[Searle and Penrose are still right; AI is not conscious]({{< ref path="/posts/artificial-intelligence/chat-gpt-y-la-habitacion-china-de-searle/index.md" lang="es" >}}) and general intelligence may perhaps require some form of consciousness.
