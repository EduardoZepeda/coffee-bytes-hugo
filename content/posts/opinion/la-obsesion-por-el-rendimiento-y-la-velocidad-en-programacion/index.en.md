...
{{< figure src="images/rust-and-go-performance-for-common-data-structures-arrays.webp" class="md-local-image" alt="Rust vs go Benchmark"  width="600" height="371" >}}
...
{{< figure src="images/techempower-benchmark.png" class="md-local-image" alt="Requests per second techempower benchmark" caption="Some frameworks can handle up to 600k requests per second"  width="864" height="531" >}}
...
{{< figure src="images/wordpress-meme.jpg" class="md-local-image" alt="Wordpress vs node meme"  width="800" height="720" >}}
...
{{< figure src="images/rustaceans-vs-gophers.png" class="md-local-image" alt="Time compilation differences between rust and go meme"  width="800" height="612" >}}
...
{{< figure src="images/design-stamina-graph.jpg" class="md-local-image" alt="Design stamina graph" caption="Credits: Martin Fowler"  width="618" height="329" >}}
...
{{< figure src="images/temple-os.webp" class="md-local-image" alt="Meme of temple os, a system that supposedly would be the third temple of Jerusalem and would allow to communicate with god."  width="800" height="881" >}}
...
{{< figure src="images/gamestop-meme.jpg" class="md-local-image" alt="Gamestop meme about an angry millonaire upsed about reddit strategy"  width="720" height="899" >}}
