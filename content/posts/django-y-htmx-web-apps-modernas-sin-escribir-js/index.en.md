...
Remember that if you are not convinced why you should use Django check my post where I explain the [advantages and disadvantages of Django](/blog/why-should-you-use-django-framework/). If you have no idea how to use Django better start with the [Django-guide](/blog/the-definitive-guide-to-django/)
...
To start, let's create a virtual environment with [the pipenv virtual environment manager](/blog/pipenv-the-virtual-environment-manager-you-don-t-know/). You can use [pip](/blog/python-virtualenv-linux-basic-tutorial/), poetry, conda or whatever you prefer.
