...
![Esquema de modelo Subcategoría con ForeignKey hacía Categoría en Django](https://coffeebytes.dev/wp-content/uploads/2022/03/CategoriaDjango-1.jpg)
...
![Esquema del problema de las subcategorías infinitas](https://coffeebytes.dev/wp-content/uploads/2022/03/ProblemaCategoriasDjango.jpg)

Cada vez que necesites crear una subcategoría nueva tendrás que crear un nuevo modelo en el archivo _models.py_ de tu aplicación. Y no solo eso, sino una nueva tabla que probablemente solo cuente con unos cuantos registros. ¿Existe una aproximación mejor al problema? El [versátil ORM de Django](https://coffeebytes.dev/por-que-deberias-usar-django-framework/) nos ofrece una solución bastante limpia.
...
![Esquema del funcionamiento de ForeignKey hacía self(el mismo modelo) en Django.](https://coffeebytes.dev/wp-content/uploads/2022/03/ForeignKeyASelfEsquemaDjango.jpg)
