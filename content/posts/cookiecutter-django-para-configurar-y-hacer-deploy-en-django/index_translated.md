...
categories:
* "django" * "docker
* "docker" * "docker" * "django" * "django" * "django"
...
This tool uses docker to simplify the process of developing and deploying a Django application. It was also created by one of the writers of the great book Two scoops of Django, of which I have a [review of Twoo scoops of django](/the-best-book-of-django-review-of-two-scoops-of-django/)

Don't know what Docker is? Visit my post where I talk about [containers and Docker](/docker-compose-tutorial-with-basic-commands/) in case you don't know how to use it. If you already know how to use Docker, and want to take a look at [docker compose](/docker-compose-tutorial-with-commands-on-gnu-linux/).

If you doubt about whether you should use Django visit my post where I explain some [advantages and disadvantages of this web development framework](/why-should-you-use-django-framework/)
...
Theoretically you can perform this procedure in any PAAS, such as [Digital Ocean](/digital-ocean-analysis-and-my-experience/), Linode, etc. I have done the procedure using a Docker Droplet on Digital Ocean and it went fine. The author has instructions for other platforms that you can check at [the official cookiecutter-django documentation](https://cookiecutter-django.readthedocs.io/en/latest/index.html).

Visit my next post, where I talk [about one of the newest Python frameworks for creating APIs](/python-fastapi-the-best-framework-of-python/).