...
The following command will create a txt extension file in our current folder. If you are not comfortable using the GNU/Linux terminal visit my series of posts where I explain the [basic GNU/Linux commands](/en/linux-basic-commands-grep-ls-cd-cat-cp-rm-scp//)
...
If you want to go deeper in Python testing I have a post where I expose some of the [Python libraries for testing](/en/unittest-python-are-python-tests-worthwhile/)
...
To deploy without using [Docker](/en/what-is-docker-and-what-is-it-for/) just run uvicorn, just like we did at the beginning of this tutorial.
