...
Actualización de 2024: Los desarrolladores frontend se dieron cuenta de que el paradigma de crear HTML con el servidor era mucho mejor que las otras opciones. Frameworks como Remix y Astro están obstando por este paradigma. Por lo anterior frameworks como Django, Ruby on Rails o la librería estándar de Go, pueden ser combinados con [frameworks como HTMX, que te permiten manejar HTML desde el servidor](/django-y-htmx-web-apps-modernas-sin-escribir-js/) para tener aplicaciones SEO friendly y con excelentes rendimientos.
