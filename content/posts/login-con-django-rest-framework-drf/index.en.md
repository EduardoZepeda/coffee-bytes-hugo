...
If you are about to develop an API, I have a post with [recommendations on REST API design](/en/rest-api-basic-characteristics-and-recommendations/) that can be useful for you.
