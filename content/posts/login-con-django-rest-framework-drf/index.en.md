...
If you are about to develop an API, I have a post with [recommendations on REST API design](/rest-api-basic-characteristics-and-recommendations/) that can be very useful for you.
