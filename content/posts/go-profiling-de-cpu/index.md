...
Igual que hicimos para ver el [coverage en el testing de go](https://coffeebytes.dev/go-testing-basico-y-coverage/), usamos un flag para crear un archivo con la información del profiling en binario, este archivo no lo podemos visualizar directamente.
...
![Resultados del comando list de profiling en go que muestra el impacto de cada linea de código. ](https://coffeebytes.dev/wp-content/uploads/2022/02/GoListProfile-1024x205.png)
...
![Resultado del comando web de profiling en go. La función fibonacci se muestra en grande y en rojo.](https://coffeebytes.dev/wp-content/uploads/2022/02/GoWebProfile.png)
...
![El comando web permite aislar los resultados por función](https://coffeebytes.dev/wp-content/uploads/2022/02/GoWebProfileFunction.png)
