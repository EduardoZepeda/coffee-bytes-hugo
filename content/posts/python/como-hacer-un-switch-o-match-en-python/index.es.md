...
- /es/como-escribir-un-switch-en-python/
authors:
- Eduardo Zepeda
categories:
- python
...
Te recuerdo que si no sabes nada de Python tengo una entrada donde hablo del [libro "Inmersion en Python"]({{< ref path="/posts/python/ya-conoces-este-libro-gratuito-de-python-3-en-espanol/index.md" lang="es" >}}); uno de los mejores libros gratuitos para aprender Python desde cero.
