...
First we are going to install the necessary libraries: djangorestframework and djangorestframework_simplejwt, the first one to create and manage our [API REST](/blog/rest-api-basic-characteristics-and-recommendations/) in Django and the second one to manage the JWTs.

To install them I will use [the virtual environment manager called Pipenv](/blog/pipenv-the-virtual-environment-manager-you-don-t-know/). You can also use pip if you want.
...
If you don't know how to use curl check my [basic GNU/Linux commands](/blog/linux-commands-you-should-know-part-two/) entry where I explain the basics. You can also use Postman, http or any other option.
