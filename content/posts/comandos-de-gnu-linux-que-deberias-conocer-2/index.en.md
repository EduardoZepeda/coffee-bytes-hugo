...
This is the second part of the list of basic GNU/Linux terminal commands. If you want to see the commands from the previous post please [enter the first part here](/blog/basic-linux-commands-you-should-know/). I also have a [third part of GNU/Linux commands available](/blog/linux-commands-you-should-know-part-two/).
...
If you don't know what a virtual environment is, I invite you to read my post where I explain [what are virtual environments in Python](/blog/why-should-you-use-a-virtual-environment-in-python/).
