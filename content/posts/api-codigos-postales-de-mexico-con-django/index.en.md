...
If you are going to develop a REST API, I have a post with multiple [REST API design recommendations](/blog/rest-api-basic-characteristics-and-recommendations/) that may help you.

For this example I use Python 3.8, Django 3.2.5 and Pipenv version 2020.5.28.

## Installation

To install it we are going to use [Pipenv](/blog/pipenv-the-virtual-environment-manager-you-don-t-know/), but you can use Poetry, [pip](/blog/python-virtualenv-linux-basic-tutorial/) or any other virtual environment manager.
