...
If your application makes heavy use of information searches, consider using an efficient [search engine, such as Solr](/blog/how-to-implement-solr-for-searches-or-queries-in-django/), rather than implementing the code yourself.
...
Would you like to dig deeper into the caching system, I have a post about [caching in django](/blog/caching-in-django-rest-framework-with-memcached/) that you can check out to dig deeper.
...
No idea where to start, I have a couple of posts where I explain [how to run asynchronous tasks with celery and django](/blog/celery-and-django-to-run-asynchronous-tasks/).
...
There are many CDN options available, among the most popular options are AWS, [Azure](/blog/azure-az-900-certification-exam-my-experience/), Digital Ocean, Cloud Flare, among others.
