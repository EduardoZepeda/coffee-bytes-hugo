...
Yes, you are correct, crontab shares the format with the [crontab file used by the GNU/Linux cron daemon](/blog/cron-and-crontab-schedules-recurring-tasks/), which I already talked about in a post.
