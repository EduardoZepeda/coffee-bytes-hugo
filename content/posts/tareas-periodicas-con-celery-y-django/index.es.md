...
Sí, estás en lo correcto, crontab comparte el formato con el archivo [crontab que usa el daemon cron de GNU/Linux](/es/programa-tareas-periodicas-facil-en-linux-con-cron-y-crontab/), del que ya hablé en una entrada.
