---
title: "Pongo a prueba a GPT-3 Con Desafios De Codigo De Codewars"
date: "2022-12-12"
...
GPT-3 está rompiendo con todo lo conocido anteriormente en inteligencia
...
entrada pongo a prueba GPT-3 contra tres desafios de codewars.
...
## Test con peticiones comunes a GPT-3

Para empezar estuve probando GPT-3 con una serie de peticiones sencillas y
populares. Encontré que GPT-3 pudo devolver el código correcto en cada ocasión
...
![](images/GPT-3-Django-users.png "Observa como sabe como reemplazar el usuario
...
que tiene GPT-3 para tareas sencillas y con información abundante en la red; no
...
El input que usé en GPT-3 para generar el código es el siguiente: Create a
...
```python
# Este código fue generado por OpenAI-GPT-3
...
Quiero resaltar que GPT-3 produce código sintácticamente correcto, respetando
...
## GPT-3 vs Find the nth Reverse Number (Extreme)
...
Si bien GPT-3 acertó solo uno de los desafios (y a medias) es capaz de resolver
...
GPT-3 se vuelve bastante ineficiente con peticiones que requieren de un
...
### ¿Es GPT-3 una amenaza?

¿Creo que GPT-3 representa va a poner en aprietos muchos trabajos? Sí, creo que
GPT-3 va a poner en dificultades a la mayoría de los trabajos no desafiantes y
