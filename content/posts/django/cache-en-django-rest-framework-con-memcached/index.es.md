...
- /es/tutorial-cache-con-django-rest-framework-y-memcached/
- /es/cache-en-django-rest-framework-con-memcached/
authors:
- Eduardo Zepeda
categories:
- django
...
- rendimiento
- API
slug: /django/cache-en-django-rest-framework-con-memcached/
...
{{< figure src="images/ComparacionCache1000filasDjango.jpg" class="md-local-image" alt="Comparación del tiempo de respuesta con caché y sin caché para una aplicación de django."  width="922" height="654" >}}
...
- djangorestframework: para la creación de [APIs de tipo REST]({{< ref path="/posts/software-architecture/caracteristicas-basicas-de-una-api-rest/index.md" lang="es" >}}).
...
{{< figure src="images/CacheDebugToolBar.png" class="md-local-image" alt="Django_debug_toolbar con caché y sin caché, comparación."  width="424" height="1022" >}}
