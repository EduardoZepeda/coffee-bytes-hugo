...
If you don't know how to use curl check my [basic GNU/Linux commands](/en/linux and devops/linux-basic-commands-passwd-du-useradd-usermod-fdisk-lscpu-apt-which/) entry where I explain the basics. You can also use Postman, http or any other option.
