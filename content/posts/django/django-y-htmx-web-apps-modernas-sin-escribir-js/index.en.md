...
{{< figure src="images/TamanoDeHTMX.png" class="md-local-image" alt="HTMX library size. 105 kB normal, 32 kB minimized and 10.8 compressed in gzip."  width="1031" height="386" >}}
...
{{< figure src="images/HtmxEsquema.jpg" class="md-local-image" alt="htmx operation scheme"  width="1200" height="1300" >}}
...
{{< figure src="images/HtmxResponse-1.gif" class="md-local-image" alt="Htmx rendering a web application"  width="1339" height="393" >}}
...
{{< figure src="images/LaEtiquetaHeadNoSeCarga.gif" class="md-local-image" alt="head tag does not load directly if we access the path"  width="1260" height="630" >}}
...
{{< figure src="images/HtmxFormSubmit-1.gif" class="md-local-image" alt="Submitting a form using htmx and django"  width="1260" height="630" >}}
...
{{< figure src="images/PeticionHTTPPost.png" class="md-local-image" alt="POST parameters automatically sent by htmx"  width="1426" height="275" >}}
...
{{< figure src="images/EncabezadosHtmx.png" class="md-local-image" alt="List of extra headers are added in each request"  width="1422" height="553" >}}
...
{{< figure src="images/HtmxConHeadDespuesDePeticion.gif" class="md-local-image" alt="Accessing the routes directly"  width="1260" height="630" >}}
