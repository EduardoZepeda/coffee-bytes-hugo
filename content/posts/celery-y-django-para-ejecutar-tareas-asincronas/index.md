...
Usar celery es una de las cosas que puedes hacer para [mejorar el rendimiento de una aplicación en Django](/como-mejorar-el-rendimiento-de-una-aplicacion-hecha-en-django/). Y también puedes crear tareas periódicas con celery y django.
