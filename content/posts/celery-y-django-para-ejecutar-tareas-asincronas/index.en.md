...
Using celery is one of the things you can do to [improve the performance of a Django application](/is-your-django-application-slow-maximize-its-performance-with-these-tips/). And you can also create periodic tasks with celery and django.
