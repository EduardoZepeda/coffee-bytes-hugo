...
To explain the topic I will assume you know the basics of slices and data types in go, if you don't know about these topics visit my [array, slices in golang](/go-slices-y-arrays-characteristicas-and-basic-uses/) entry.

If this is your first approach to go, take a look at my [introduction to the go programming language](/go-programming-language-introduction-to-variables-and-data-types/) post and then come back here.
