...
date: '2020-10-27'
seo_title: "FastAPI Tutorial: Build Fast Python APIs"
description: Learn FastAPI fundamentals, the fastest Python web framework. Complete
  tutorial with Docker and best practices for building APIs.
keywords:
- fastapi
- docker
- REST
...
These last few days I have been testing a Python library that is becoming famous, FastAPI, a framework for creating APIs, such as [REST APIs]({{< ref path="/posts/software-architecture/caracteristicas-basicas-de-una-api-rest/index.md" lang="en" >}}) or RPC APIs. FastAPI promises to help us create fast APIs in a simple way, with very little code and with extraordinary performance, to support high concurrency websites.
...
{{< figure src="images/Middleware.png" class="md-local-image" alt="Basic schematic of a middleware"  width="600" height="200" >}}
...
{{< figure src="images/Documentacion_swagger.png" class="md-local-image" alt="Screenshot of swagger documentation"  width="1487" height="239" >}}
