...
Si no conoces los comandos de GNU/Linux tengo una serie de entradas [con los comandos más usados de GNU Linux](/es/comandos-basicos-de-linux-grep-ls-cd-history-cat-cp-rm-scp/)
