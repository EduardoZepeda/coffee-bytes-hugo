...
I mean nobody is going to hate you if your furry images site is down for a couple of hours, put a "touch some grass" page and perform the migration, [don't obsess unnecessarily about your app's performance.]({{< ref path="/posts/opiniones/la-obsesion-por-el-rendimiento-y-la-velocidad-en-programacion/index.md" lang="en" >}})
...
Now comes the bulk data migration. **Never try to copy everything at once**, that's a recipe for a digital hecatombe. Remember the [worker pool pattern's]({{< ref path="/posts/arquitectura-de-software/el-patron-de-diseno-worker-pool-aprovechando-la-concurrencia-en-go/index.md" lang="en" >}}) reason of existance.
...
For tables with millions of QPS, or [million of concurrent users]({{< ref path="/posts/arquitectura-de-software/como-mejorar-el-rendimiento-de-una-aplicacion-hecha-en-django/index.md" lang="en" >}}), you can opt for using a queue instead of directly writes.
