...
{{< figure src="images/djangoRocketNoCursor.gif" class="md-local-image" alt="Django installation success page, shows welcome message and links to documentation"  width="735" height="602" >}}