...
{{< figure src="images/djangoRocketNoCursor.gif" class="md-local-image" alt="Página de instalación exitosa de Django, muestra un mensaje bienvenida y enlaces a la documentación."  width="735" height="602" >}}