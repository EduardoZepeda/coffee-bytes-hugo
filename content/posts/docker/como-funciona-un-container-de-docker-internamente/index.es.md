...
Creamos un directorio para nuestro cgroup con los [permisos de linux 0755]({{< ref path="/posts/linux/permisos-en-gnu-linux-y-el-comando-chmod/index.md" lang="es" >}})
