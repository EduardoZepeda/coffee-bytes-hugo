...
- yml
- devops
slug: /docker/docker-compose-tutorial-con-comandos-en-gnu-linux/
...
La configuración environment nos permite establecer una lista de [variables de entorno](/es/linux y devops/comandos-basicos-de-linux-printenv-export-lsof-top-ps-kill-curl-systemctl-chown-chroot/) que estarán disponibles en nuestro servicio.
...
¿Que tal una aplicación práctica de Docker Compose? En mi siguiente entrada te explico como hacer un [deploy usando cookiecutter-django y docker-compose](/es/django/cookiecutter-django-para-configurar-y-hacer-deploy-en-django/); gracias a cookie-cutter bastan un par de comandos de docker-compose y listo, una aplicación lista para producción, con SSL y muchas más funciones.