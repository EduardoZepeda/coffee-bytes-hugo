...
{{< figure src="images/Diferencias-entre-maquina-virtual-y-docker.png" class="md-local-image" alt="Differences between a virtual machine and docker"  width="748" height="500" >}}
