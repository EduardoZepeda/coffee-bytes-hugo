...
{{< figure src="images/evaluaasi-plataforma.jpg" class="md-local-image" alt="Evaluaasi plataforma" caption="Pantalla de inicio de la plataforma de evaluassi"  width="1672" height="576" >}}
...
{{< figure src="images/portal-azure.png" class="md-local-image" alt="Captura de pantalla del portal de Azure" caption="Portal de azure"  width="1051" height="209" >}}
...
{{< figure src="images/plataforma-microsoft-learn.jpg" class="md-local-image" alt="Plataforma de microsoft Learn" caption="Plataforma de microsoft learning"  width="951" height="914" >}}
...
{{< figure src="images/aprender-big-data.jpg" class="md-local-image" alt="Aprender big data"  width="1194" height="666" >}}
...
En general los dos primeros son bastantes sencillos, sobre todo si ya tienes experiencia usando los [comandos básicos de la linea de comandos]({{< ref path="/posts/linux/comandos-de-gnu-linux-que-deberias-conocer/index.md" lang="es" >}}), los últimos dos sí requieren algo de experiencia o mucha práctica de tu parte para aprobarlos.

{{< figure src="images/administracion-servidores-linux.jpg" class="md-local-image" alt="Curso de Platzi de administración de servidores Linux" caption="Curso de administración de servidores Linux"  width="1283" height="801" >}}
