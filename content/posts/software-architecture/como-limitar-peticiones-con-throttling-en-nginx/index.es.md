...
Si lo que buscas es optimizar el rendimiento de una aplicación que usa Nginx tengo una entrada donde te doy algunas [recomendaciones para mejorar el rendimiento de nginx.](/es/linux y devops/nginx-keepalive-gzip-http2-mejor-rendimiento-en-tu-sitio-web/)
