...
- /es/pongo-a-prueba-a-chatgpt-con-desafios-de-codigo-de-codewars/
authors:
- Eduardo Zepeda
categories:
...
date: '2022-12-12'
seo_title: "ChatGPT vs CodeWars: Probando su Inteligencia"
description: Puse a prueba a ChatGPT con desafíos de código de CodeWars para ver si
  realmente puede programar. Resultados sorprendentes y decepcionantes.
keywords:
- artificial intelligence
- automatas
- code wars
...
ChatGPT está rompiendo con todo lo conocido anteriormente en inteligencia artificial, algunos desarrolladores están preocupados de que [una Inteligencia Artificial pueda reemplazarlos en sus trabajos]({{< ref path="/posts/artificial-intelligence/devin-de-cognition-labs-la-inteligencia-artificial-que-reemplaza-a-los-programadores/index.md" lang="es" >}}), justo como amenazó Github Copilot en su momento. En esta entrada pongo a prueba la [supuesta inteligencia de ChatGPT]({{< ref path="/posts/artificial-intelligence/chat-gpt-y-la-habitacion-china-de-searle/index.md" lang="es" >}}) contra tres desafios de codewars. 
...
Sin embargo, hay un pequeño error, a pesar de producir los resultados de manera correcta, el código no pasa las pruebas por que el [rendimiento de Big O]({{< ref path="/posts/linux/la-notacion-big-o/index.md" lang="es" >}}) de la inteligencia artificial es insuficiente para la prueba.
...
¿Creo que ChatGPT representa va a poner en aprietos muchos trabajos? Sí, va a poner en dificultades a la mayoría de los trabajos (no necesariamente aquellos relacionados con código) no desafiantes y cuya dificultad radique en una sencilla búsqueda de google, o tareas automatizables, que requieran razonamientos simples. Sin embargo, considero que no es la veracidad de sus respuestas, sino su interfaz tipo chat, y la inmediatez de sus respuestas, la que la podrían volver bastante popular.

Por otro lado, [algunos ven a la IA como un culto delirante]({{< ref path="/posts/opinion/el-nuevo-dios-el-delirante-culto-a-la-ai-en-redes/index.md" lang="es" >}}) que puede traer expectativas irreales que no corresponden con sus capcidades, así como la falsa ilusión de su cercanía con la AI, lo que puede complicar las cosas para el lado de los empleados, definitivamente hay un[ hype por la AI]({{< ref path="/posts/artificial-intelligence/la-burbuja-de-ai-y-sus-consecuencias/index.md" lang="es" >}}) que no se corresponde con la realidad.