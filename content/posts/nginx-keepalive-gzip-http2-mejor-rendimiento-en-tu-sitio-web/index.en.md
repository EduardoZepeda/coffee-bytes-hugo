...
Remember that you can query all available MIME types in a friendly way by doing a [bat](/en/get-to-know-bat-in-linux-the-syntax-highlighting-cat/) or a cat to the following file:
