...
This is the second part of the list of basic GNU/Linux terminal commands. If you want to see the commands from the previous post please [enter the first part here](/en/linux/linux-basic-commands-grep-ls-cd-cat-cp-rm-scp//). I also have a [third part of GNU/Linux commands available](/en/linux/linux-basic-commands-lsof-top-ps-kill-systemctl-chown-chroot/). 
