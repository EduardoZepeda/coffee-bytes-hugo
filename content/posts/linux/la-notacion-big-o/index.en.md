...
{{< figure src="images/BigO_notacion.jpg" class="md-local-image" alt="First picture of a black hole" caption="First picture of a black hole"  width="1200" height="628" >}}
...
On the other hand, some offer better performance with little data, while others shine when processing a lot of information. For example [Bloom Filters]({{< ref path="/posts/databases/bloom-filter/index.md" lang="en" >}}) with outstanding performance when checking membership of an element in a set. Or [Swiss Tables]({{< ref path="/posts/software-architecture/swiss-tables/index.md" lang="en" >}}) that use Parallelism to accelerate the lookup of keys.
