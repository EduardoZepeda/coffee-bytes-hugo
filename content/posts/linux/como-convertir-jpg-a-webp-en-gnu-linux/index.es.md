...
- /es/como-convertir-jpg-a-webp-en-gnu-linux/
authors:
- Eduardo Zepeda
categories:
- linux
...
date: '2020-09-10'
seo_title: "Convertir JPG a WebP en Linux: Fácil y Rápido"
description: Aprende a convertir imágenes de JPG a WebP en Linux con herramientas de
  línea de comandos. Proceso rápido y optimizado.
keywords:
- linux
- frontend
...
Si el siguiente comando no te suena o quieres repasar los comandos básicos de GNU/Linux por favor visita mis entradas donde hablo de los [comandos más usuales de GNU Linux]({{< ref path="/posts/linux/comandos-de-gnu-linux-que-deberias-conocer/index.md" lang="es" >}}).
