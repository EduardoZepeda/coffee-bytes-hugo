...
Previously I explained you how to implement [full text search in Django](/blog/full-text-search-and-searches-with-django-and-postgres/) and [trigrams-and-search-rank](/blog/trigrams-and-advanced-searches-with-django-and-postgres/) using Postgres. Solr comes to offer us something better, a robust, stable and feature-rich search engine, ready to use, in exchange for a little more complexity, more dependencies and having to include Java (yes, Java) in our project.
...
Solr has many [advanced features, such as autocomplete, suggestions, search by field and others](/blog/autocomplete-suggestions-and-related-content-solr-and-django/)
