...
![Google trends comparando Go vs Python. Python es más popular a la fecha.](images/Python-vs-go-popularidad-1024x525.png)
...
![Encuesta de stackoverflow 2021 con lso lenguajes más queridos y odiados. Go es más querido que Python.](images/go-vs-python-stackoverflow-2021-1024x686.png)
...
![Comparación de salarios por lenguaje según la encuesta de stackoverflow. Go está en el top 10](images/go-vs-python-salarios-1024x851.png)
...
![Captura de pantalla del índice de paquetes de Python Pypi](images/Pypi-1024x368.png)
...
![Frameworks de Go más conocidos: Hugo, Beego, Echo, Buffalo, Go revel](images/Frameworks-web-Go-1024x538.jpg)
