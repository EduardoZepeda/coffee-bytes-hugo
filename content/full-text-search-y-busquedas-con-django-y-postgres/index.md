...
![Creación de un tsvector en postgres](images/tsvector-en-postgres-1024x538.png)
...
![Esquema de full text search en Postgres](images/FullTextSearchEsquema-1024x538.png)
...
![Transformación de una cadena de texto en un tsquery en Postgres](images/tsquery-postgres-1024x538.png)
